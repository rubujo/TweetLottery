namespace TweetLottery
{
	partial class FMain
	{
		...
		private void InitializeComponent()
		{
			...
			// CBHideTokenField
			// 
			CBHideTokenField.AutoSize = true;
			CBHideTokenField.Location = new Point(349, 93);
			CBHideTokenField.Name = "CBHideTokenField";
			CBHideTokenField.Size = new Size(115, 19);
			CBHideTokenField.TabIndex = 11;
			CBHideTokenField.Text = "隱藏 Token 欄位";
			CBHideTokenField.UseVisualStyleBackColor = true;
			CBHideTokenField.CheckedChanged += CBHideTokenField_CheckedChanged;
			// 
			// FMain
			// 
		...
		private CheckBox CBHideTokenField;
	}
}